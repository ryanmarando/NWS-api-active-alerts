                ...
                <div className="relative flex h-full w-full justify-center">
                    ...
                    <div className="absolute w-[97%] md:w-[97%] flex mt-[450px] md:mt-[600px] lg:ml-[45%] lg:mt-60 lg:m-0 lg:w-[50%] text-center justify-center">
                        <p className="border-2 border-gray-800 rounded-md p-1 lg:p-2">
                            Colleagues call me an engaging and compelling
                            meteorologist who blends storytelling and science
                            with ease. As a Meteorologist for WHIO in Dayton,
                            Ohio,{" "}
                            <strong>
                                I shape my forecasts to help the community
                                understand the impacts of everyday to dangerous,
                                severe weather.
                            </strong>
                        </p>
                        <p className="border-2 border-gray-800 rounded-md p-1 lg:p-2 ml-2">
                            What I enjoy most is serving my community by
                            producing accurate, digestible, and refreshing
                            forecasts using creativity with augmented 3D
                            graphics and enhancing them with my Python
                            certification and programming experience.
                            <strong>
                                {" "}
                                To me, it&apos;s important to not only tell the
                                weather story but also the context and
                                perspective behind it so viewers truly
                        ...
                        <p className="border-2 border-gray-800 rounded-md p-1 lg:p-2 ml-2">
                            ...
                            <strong>
                                {" "}
                                My constant curiosity about our world and the
                                impact science has started when I was young
                                growing up in Bear, Delaware.
                            </strong>
                            That love fueled my education graduating Summa Cum
                            Laude as Embry-Riddle Aeronautical University&apos;s
